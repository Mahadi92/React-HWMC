...
import {
  _createClass,
  _toConsumableArray
} from "./chunk-W2RZ642T.js";
import {
  _assertThisInitialized
} from "./chunk-KUBMRBV4.js";
import {
  _extends
...
var useEffectOrLayoutEffect = module_default ? import_react2.useLayoutEffect : import_react2.useEffect;
var noTheme = {};
var createUseStyles = function createUseStyles2(styles, options) {
  ...
  return function useStyles(data) {
    ...
    var _React$useMemo = (0, import_react2.useMemo)(function() {
...
function JssProvider(props) {
  ...
  var createContext3 = function createContext4(parentContext, prevContext) {
    ...
    var registry = props.registry, classNamePrefix = props.classNamePrefix, jss = props.jss, generateId = props.generateId, disableStylesGeneration = props.disableStylesGeneration, media = props.media, id = props.id;
  ...
  if (dynamicStyles.length > 1) {
    styles.scd = function(props) {
      ...
      for (var i = 0; i < dynamicStyles.length; i++) {
        ...
        if (dynamicStyle)
          Object.assign(merged, dynamicStyle);
      }
      return merged;
    };
  }
...
// dep:react-jss
var react_jss_default = react_jss_esm_default;
export {
  JssContext,
  JssProvider,
  SheetsRegistry,
